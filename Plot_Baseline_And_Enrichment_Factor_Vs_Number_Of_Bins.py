...
tenth_percentile_of_observed_docking_scores = np.percentile(data_frame_of_observed_and_averaged_predicted_docking_scores['observed_docking_score'], 10)
list_of_indicators_that_observed_docking_score_belongs_to_lowest_10_percent = [1 if observed_docking_score < tenth_percentile_of_observed_docking_scores else 0 for observed_docking_score in data_frame_of_observed_and_averaged_predicted_docking_scores['observed_docking_score']]
...
data_frame_of_observed_and_averaged_predicted_docking_scores_and_indicators_that_observed_docking_score_belongs_to_lowest_10_percent['belongs_to_lowest_10_percent'] = list_of_indicators_that_observed_docking_score_belongs_to_lowest_10_percent

column_belongs_to_lowest_10_percent = data_frame_of_observed_and_averaged_predicted_docking_scores_and_indicators_that_observed_docking_score_belongs_to_lowest_10_percent['belongs_to_lowest_10_percent']
number_of_docking_scores_in_lowest_10_percent = sum(column_belongs_to_lowest_10_percent)
number_of_docking_scores = data_frame_of_observed_and_averaged_predicted_docking_scores_and_indicators_that_observed_docking_score_belongs_to_lowest_10_percent.shape[0]
number_of_bins = 10
...
append_baseline_or_enrichment_factor_to_list_of_baselines_or_enrichment_factors(data_frame_of_observed_and_averaged_predicted_docking_scores_and_indicators_that_observed_docking_score_belongs_to_lowest_10_percent, list_of_baselines)
data_frame_of_observed_and_averaged_predicted_docking_scores_and_indicators_that_observation_belongs_to_lowest_10_percent_ordered_by_averaged_predicted_docking_score = data_frame_of_observed_and_averaged_predicted_docking_scores_and_indicators_that_observed_docking_score_belongs_to_lowest_10_percent.sort_values(by = 'averaged_predicted_docking_score', ascending = True)
