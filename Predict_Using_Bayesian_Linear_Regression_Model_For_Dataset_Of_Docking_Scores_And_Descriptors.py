...
def main():
    ...
    with pymc.Model() as pymc_model:
        ...
        tensor_variable_representing_prior_probability_density_distribution_for_constant_term = pymc.Normal('constant_term', mu = 0, sigma = 10)
        tensor_variable_representing_prior_probability_density_distribution_for_vector_of_coefficients = pymc.Normal('vector_of_coefficients', mu = 0, sigma = 10, shape = 2)
        tensor_variable_representing_prior_probability_density_distribution_for_standard_deviation = pymc.HalfNormal('standard_deviation', sigma = 1)
        tensor_variable_representing_expected_value_mu_of_outcomes = (
    ...
    data_frame_of_observed_and_averaged_predicted_numbers_of_bike_rentals.to_csv(path_or_buf = 'Data_Frame_Of_Observed_And_Averaged_Predicted_Docking_Scores_Predicted_By_Bayesian_Linear_Regression_Model.csv', index = False)
